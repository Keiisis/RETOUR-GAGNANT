            ...
            <Card className="bg-[#0a0f18] border-white/5 p-8 rounded-[2.5rem]">
                <form onSubmit={handleSave} className="space-y-6">
                    <div className="space-y-3">
                        <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.4em]">Titre de l'étape</label>
                        <input
                    ...
                    <div className="space-y-3">
                        <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.4em]">Ordre d'affichage</label>
                        <input
                            type="number"
