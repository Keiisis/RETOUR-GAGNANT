            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                        ...
                        <form className="space-y-10">
                            ...
                            <div className="space-y-3">
                                <label className="text-[10px] font-black text-gray-500 uppercase tracking-[0.4em] ml-1 flex items-center justify-between">
                                    <span className="flex items-center gap-2">Contenu du Témoignage {isOptimizing && <Loader2 size={12} className="animate-spin text-[#3b82f6]" />}</span>
                                    <button
                                        type="button"
                ...
                <div className="lg:col-span-5 space-y-8">
                    ...
                    <Card className="bg-[#0a0f18] border-white/5 p-8 rounded-[2.5rem] shadow-3xl">
                        <h3 className="text-white font-black font-heading text-lg mb-6 flex items-center gap-3">
                            <ShieldCheck size={20} className="text-[#3b82f6]" /> Contrôle Editorial
                        </h3>
                            ...
                            <div className="flex items-center justify-between p-6 bg-white/5 rounded-[1.5rem] border border-white/5">
                                ...
                                >
                                    <div className={cn(
                                        ...
                                        formData.approved ? "translate-x-8" : "translate-x-0"
                                    )} />
                                </button>
                            </div>
                        ...
                        <Card className="bg-[#0a0f18] border-white/5 rounded-[2.5rem] p-10 shadow-3xl relative overflow-hidden group border-2 border-white/5">
                            ...
                            <div className="relative space-y-6">
                                ...
                                <div className="pt-6 border-t border-white/5">
                                    <span className="text-[9px] font-black text-gray-600 uppercase tracking-widest bg-white/5 px-4 py-1.5 rounded-full border border-white/5">
