...
import { Download, CircleNotch as Loader2, ArrowClockwise as RefreshCw, ArrowLeft, Eye, ArrowsOut as Maximize2, ArrowsIn as Minimize2 } from '@phosphor-icons/react';
import Link from 'next/link'
import { generatePlexiglasSVG, downloadPlexiglasSVG } from '@/lib/svg-plexiglas-generator'
...
/* Ombre murale (projetée derrière le panneau) */
...
/* Épaisseur du plexiglas (bord 3D) */
...
/* Reflet de surface (glossy highlight) */
...
/* Reflet lumineux ponctuel (comme une lumière de studio) */
...
/* Micro-reflet vertical (bord gauche du verre) */
...
export default function PlexiglasPage() {
    ...
    const loadPreview = useCallback(async () => {
        ...
        try {
            ...
            console.error('[Plexiglas] Erreur preview:', e)
        } finally {
            setLoading(false)
        }
    }, [])
    ...
    const handleDownload = async () => {
        setDownloading(true)
        try { await downloadPlexiglasSVG() } finally { setDownloading(false) }
    }
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-center gap-4 flex-wrap">
                ...
                <div className="flex-1 min-w-0">
                    <h1 className="text-xl font-bold text-white">Mockup Plexiglas 3D</h1>
                    <p className="text-sm text-gray-500">80cm &times; 120cm &mdash; Rendu r&eacute;aliste &mdash; SVG vectoriel pour d&eacute;coupe CNC</p>
                </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                {[
                    ...
                    { label: 'Format', value: 'SVG Vectoriel', sub: '\u00c9ditable Illustrator' },
                    { label: 'D\u00e9coupe', value: 'Contour dor\u00e9', sub: 'CNC / Laser' },
            ...
            <div className={`relative rounded-2xl border border-white/10 overflow-hidden transition-all ${
                ...
                <div className="absolute top-4 left-4 z-20 flex items-center gap-2 px-3 py-1.5 rounded-lg bg-black/60 backdrop-blur-sm border border-white/10">
                    ...
                    <span className="text-xs text-gray-300 font-medium">Rendu 3D &mdash; Mockup Plexiglas R.G.B</span>
                </div>
                ...
                {loading ? (
                    <div className="flex flex-col items-center justify-center py-40 gap-4" style={{ background: WALL_BG }}>
                        ...
                        <p className="text-gray-600 text-sm font-medium">G&eacute;n&eacute;ration du mockup plexiglas...</p>
                    </div>
                ) : (
            ...
            <div className="rounded-xl bg-[#C9A84C]/5 border border-[#C9A84C]/20 p-4">
                ...
                <ul className="text-gray-400 text-xs space-y-1 list-disc list-inside">
                    <li>Le <strong className="text-white">contour dor&eacute; ext&eacute;rieur</strong> est le trait de d&eacute;coupe CNC/laser</li>
                    <li>Tous les textes sont en <strong className="text-white">vectoriel pur</strong> &mdash; &eacute;ditables dans Illustrator</li>
                    <li>Le logo et QR code sont embarqu&eacute;s en base64 &mdash; pas de fichiers externes</li>
                    <li>Dimensions exactes : <strong className="text-white">800mm &times; 1200mm</strong> (1 unit&eacute; SVG = 1mm)</li>
                    <li>Police : <strong className="text-white">Montserrat</strong> (Google Fonts) &mdash; installer en local si n&eacute;cessaire</li>
                    <li>Le rendu 3D ci-dessus est une <strong className="text-white">simulation visuelle</strong> &mdash; le fichier SVG t&eacute;l&eacute;charg&eacute; est un fichier vectoriel plat</li>
                </ul>
            </div>
        </div>
    )
