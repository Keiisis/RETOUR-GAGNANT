...
import { ArrowLeft, MapPin, Image as ImageIcon, Sparkle as Sparkles, CircleNotch as Loader2, Plus, Trash as Trash2, GridFour as Grid, Check, X, FilePlus } from '@phosphor-icons/react';
                        ...
                        <form className="space-y-10">
                            <div className="space-y-3">
                                <label className="text-xs font-black text-[#FCD116] uppercase tracking-[0.3em] ml-1 flex items-center gap-2">
                                    <FilePlus size={14} /> Désignation Officielle
                                </label>
                                <input
                                    name="title"
                    ...
                    <div className="sticky top-10 space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <div className="relative aspect-[3/4] rounded-[3rem] overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,0,0,0.8)] border-4 border-white/5 group">
                                ...
                                <div className="absolute bottom-0 left-0 w-full p-10">
                                    ...
                                    <h2 className="text-4xl font-black text-white font-heading leading-[0.9] mb-4">{formData.title || "Nom du Site"}</h2>
                        ...
                        <Card className="bg-[#0a0f18] border-[#FCD116]/20 p-8 rounded-[2.5rem]">
                            ...
                            <motion.button
                                ...
                                className={cn(
                                    "w-full bg-white/5 border border-[#FCD116]/20 py-4 rounded-2xl flex items-center justify-center gap-3 group hover:bg-[#FCD116]/10 transition-all",
