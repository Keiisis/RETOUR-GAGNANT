...
export const DEFAULT_RECAP_MYAFRO: ServiceLandingContent = {
    ...
    etapes: [
        ...
        { num: "03", title: "Vous recevez votre fiche", desc: "Un document écrit sous 48 heures ouvrées : blocages, pièces à réunir, marche à suivre, et ce que le cabinet prend en charge ensuite." },
    ],
