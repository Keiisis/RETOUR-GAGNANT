...
const MUTED     = '#6B5E50'   // Taupe pour les secondaires
const WHITE     = '#FFFFFF'
  ...
  ({ scale = 1 }, ref) => {
    ...
    return (
      <div ref={ref} style={{
        ...
        {/* ── Bande tricolore supérieure (Navy / Terracotta / Amber) ── */}
        <div style={{
          position: 'absolute', top: 0, left: 0, right: 0,
          height: 5 * s, display: 'flex',
        }}>
        ...
        {/* ── Bande tricolore inférieure (Amber / Terracotta / Navy) ── */}
        <div style={{
    ...
    return (
      <div ref={ref} style={{
        ...
        <div style={{
          ...
          <div style={{
            flex: 1,
            padding: `${36 * s}px ${42 * s}px ${30 * s}px ${42 * s}px`,
            display: 'flex',
            ...
            <div style={{
              ...
              {data.phone && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 * s }}>
                  <IcoPhone sz={Math.round(20 * s)} col={AMBER} />
                  <span style={{
                    color: NAVY_DEEP,
                    fontSize: 18 * s,
                    fontWeight: 800,
              ...
              {data.email && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 12 * s }}>
                  <IcoMail sz={Math.round(20 * s)} col={AMBER} />
                  <span style={{
                    color: NAVY_DEEP,
                    fontSize: 18 * s,
                    fontWeight: 800,
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 * s }}>
                <IcoPin sz={Math.round(18 * s)} col={AMBER} />
                <span style={{
                  color: NAVY_DEEP,
                  fontSize: 13.5 * s,
                  fontWeight: 800,
