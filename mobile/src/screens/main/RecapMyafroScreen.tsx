...
export default function RecapMyafroScreen({ navigation }: { navigation: any }) {
    ...
    const [vue, setVue] = useState<Vue>('service')
        ...
        return (
            <View style={styles.container}>
                ...
                <View style={styles.entete}>
                    <Pressable onPress={() => setVue('service')} style={styles.rond} hitSlop={8} accessibilityRole="button" accessibilityLabel={t('Retour')}>
                ...
                <KkiapayModal
                    ...
                    onCancel={() => navigation.navigate('ResultatPaiement', {
                        ...
                        montant: montantXof,
                        devise: 'XOF',
                        actionLabel: t('Reprendre ma demande'),
                    })}
