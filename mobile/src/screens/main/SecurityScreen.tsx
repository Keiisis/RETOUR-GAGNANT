...
const styles = StyleSheet.create({
    ...
    cardHeaderIcon: {
        ...
        alignItems: 'center', justifyContent: 'center',
        borderWidth: 1, borderColor: C.surfaceSoft,
    },
    ...
    twofaIconBox: { width: 40, height: 40, borderRadius: radius.md, backgroundColor: C.surfaceSoft, alignItems: 'center', justifyContent: 'center' },
    twofaStatus: { fontSize: 12, color: C.textMuted, marginTop: 2 },
    twofaDesc: { fontSize: 13, color: C.textSec, lineHeight: 19 },
    twofaHint: { fontSize: 12.5, color: C.textMuted },
    twofaSecret: { ...typography.button, fontSize: 13, color: '#3C3C3C',  backgroundColor: C.surfaceAlt, borderRadius: radius.xs, paddingVertical: spacing.sm, paddingHorizontal: spacing.sm, letterSpacing: 1 },
    twofaQrWrap: { alignSelf: 'center', backgroundColor: C.surface, padding: spacing.sm, borderRadius: radius.md, borderWidth: 1, borderColor: C.border },
    twofaQr: { width: 168, height: 168 },
    twofaInput: { borderWidth: 1, borderColor: C.border, borderRadius: radius.sm, paddingVertical: 12, textAlign: 'center', fontSize: 18, letterSpacing: 6, color: '#3C3C3C', backgroundColor: C.surface },
    twofaPrimaryBtn: { backgroundColor: C.primary, borderRadius: radius.sm, paddingVertical: spacing.md, alignItems: 'center' },
    twofaPrimaryText: { color: C.primaryText, ...typography.button, fontSize: 14 },
    twofaGhostBtn: { borderWidth: 1, borderColor: C.danger, borderRadius: radius.sm, paddingVertical: 12, alignItems: 'center' },
